...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_update_user_returns_error(self):
        ...
        new_user = create_user(
            email='user2@example.com', password='test2pass123',
        )
        recipe = create_recipe(user=self.user)
    ...
    def test_create_recipe_with_new_ingrdients(self):
    ...
    def test_creating_recipe_with_exisisting_ingredients(self):
    ...
    def test_filter_by_ingredients(self):
        ...
        r2 = create_recipe(user=self.user, title='Chicken Cacciatiore')
